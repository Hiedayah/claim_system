...
class ApplicationController < ActionController::Base
	...
	protected
	    ...
	    def configure_permitted_parameters
		  	devise_parameter_sanitizer.permit(:sign_up, keys: [:name, :no_phone, :company, :postion, :bank_account, :bank_name])
			devise_parameter_sanitizer.permit(:account_update, keys: [:name, :no_phone, :company, :postion, :bank_account, :bank_name])
    	end
