...
SimpleForm.setup do |config|
  ...
  config.wrappers :vertical_form, tag: 'div', class: 'form-group', error_class: 'form-group-invalid', valid_class: 'form-group-valid' do |b|
    ...
    b.optional :min_max
    b.optional :readonly
    b.use :label, class: 'form-control-label col-md-3'
    b.wrapper :div, class: 'col-md-12' do |bb|
  ...
  config.wrappers :file_select, tag: 'div', class: 'form-group' do |b|
    b.use :html5
    b.optional :readonly
    b.wrapper tag: 'div', class: 'custom-file' do |ba|
      ba.use :input, class: 'custom-file-input'
      ba.use :label, class: 'custom-file-label form-control-label'
      ba.use :error, wrap_with: { tag: 'div', class: 'invalid-feedback' }, class: 'form-control-danger'
      ba.use :hint,  wrap_with: { tag: 'small', class: 'form-text text-muted' }
    end
  end

  config.wrappers :vertical_file_input, tag: 'div', class: 'custom-file' do |b|
    b.use :html5
    b.use :placeholder
    b.optional :maxlength
    b.optional :readonly
