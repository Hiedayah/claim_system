...
class ClaimsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create claim" do
    assert_difference('Claim.count') do
      post claims_url, params: { claim: { aasm_state: @claim.aasm_state, approver_id: @claim.approver_id, date: @claim.date, staff_id: @claim.staff_id, status: @claim.status, verifier_id: @claim.verifier_id } }
    end
  ...
  test "should update claim" do
    patch claim_url(@claim), params: { claim: { aasm_state: @claim.aasm_state, approver_id: @claim.approver_id, date: @claim.date, staff_id: @claim.staff_id, status: @claim.status, verifier_id: @claim.verifier_id } }
